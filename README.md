...
3. Генерируем user CTR для двух группы, где среднее для контрольной группы равно success_rate, а для тестовой группы - success_rate * (1 + uplift). Пусть uplift = 0.2.
