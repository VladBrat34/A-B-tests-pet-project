...
```
   ...
   рассчитываем глобальный CTR для каждой корзины. Каждую группу можно рассматривать как «мета-пользователя», а глобальный CTR корзины — как CTR этого мета-пользователя. Затем можно применить t-тест к этим мета-пользователям, поскольку корзины независимы.
...
Как можно заметить, на конкретно этих данных t-тест был менее эффективен. Тест Манна-Уитни сложнее, но имеет хорошую мощность. Более навороченные тесты бутстрэп и бакетизация показали самую большую мощность.
